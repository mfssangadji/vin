...
@section('title', 'Tambah Penerimaan Beasiswa')
@section('content')
	    <div class="x_panel">
			<div class="x_title">
			...
			<div class="x_content">
				<br />
				<form id="demo-form2" method="post" action="{{route('beasiswa')}}" data-parsley-validate class="form-horizontal form-label-left">
					@csrf
