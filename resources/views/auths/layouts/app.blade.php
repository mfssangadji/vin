        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <div style="text-align: center; padding-right: 20px;">
              <img src="{{ asset('dashboard/images/img.jpg') }}" style="width: 50px;" alt="..." class="img-circle profile_img">
            </div>
            <!-- /menu profile quick info -->
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-gear"></i> Pengaturan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{route('users')}}">Data Administrator</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> Pendataan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{route('sekolah')}}">Data Sekolah</a></li>
                      <li><a href="{{route('siswa')}}">Data Siswa</a></li>
                    </ul>
                  </li>
                  <li>
                    <a href="{{route('ijazah')}}"><i class="fa fa-edit"></i> Pengambilan Ijazah </a>
                  </li>
                  <li>
                    <a href="{{route('beasiswa')}}"><i class="fa fa-edit"></i> Penerimaan Beasiswa </a>
                  </li>
                </ul>
              </div>
              <div class="menu_section">
                <h3>Lainnya</h3>
                <ul class="nav side-menu">
                  <li><a href="{{url('../')}}" target="_blank"><i class="fa fa-sign-out"></i> Kunjungi Situs</a></li>
