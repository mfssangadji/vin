...
<html lang="en">
  <head>
    ...
    <title>Sistem Informasi Pengambilan Ijazah dan Beasiswa - @yield('title')</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="{{route('dashboard')}}" class="site_title"><span><center>Selamat Datang!</center></span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  <li>
                    <a href="{{route('welcome')}}"><i class="fa fa-home"></i> Beranda </a>
                  </li>
                  <li>
                    <a href="{{url('pijazah')}}"><i class="fa fa-bars"></i> Pengambilan Ijazah </a>
                  </li>
                  <li>
                    <a href="{{url('pbeasiswa')}}"><i class="fa fa-bars"></i> Penerimaan Beasiswa </a>
                  </li>
                  <li>
                    <a href="{{url('ptentang')}}"><i class="fa fa-bars"></i> Tentang Kami </a>
                  </li>
                  <li>
                    <a href="{{url('pkontak')}}"><i class="fa fa-bars"></i> Kontak </a>
                  </li>
                </ul>
              </div>
              <div class="menu_section">
                <h3>Lainnya</h3>
                <ul class="nav side-menu">
                  <li><a href="{{url('webadmin')}}"><i class="fa fa-sign-out"></i> Login Admin</a></li>
                </ul>
              </div>
            </div>
          </div>
